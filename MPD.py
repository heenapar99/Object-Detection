...
#https://thumbs.dreamstime.com/b/abstract-eye-background-vision-concept-d-rendering-105098094.jpg 
#https://th.bing.com/th/id/OIP.NFW-zooxcfZwo2JtUYFuVgHaEK?pid=ImgDet&rs=1
page_bg_img = f"""
<style>
.main {{
...
class Detection:
    ...
    def __call__(self):
        ...
        st.subheader(":orange[Empower your maintenance team with machine part detection technology.]")
